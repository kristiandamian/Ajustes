# Django settings for ajustes project.
DEBUG = True
TEMPLATE_DEBUG = DEBUG

ADMINS = (
    ('Kristian Damian', 'kristiandamian@gmail.com'),
)
...
SECRET_KEY = '#t1mkvqrn1n0&+v21kznv60r*bv7$cvk7k(80)@gbpo3o!3isp'
